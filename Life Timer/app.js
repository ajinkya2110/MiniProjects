...
const settingsCog = document.getElementById("settingsIcon");
const settingContent = document.getElementById("settingsContentId");
...
const contentToggler = ()=>{
    ...
    if(dateOfBirth){
        ...
        afterContentEl.classList.add("hide");
        initialContentEl.classList.remove("hide");
     }
 };
...
settingsCog.addEventListener("click", toggleDateofBirthSelector);
